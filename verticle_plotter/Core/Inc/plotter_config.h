...
#define Target_Pos_1R 0x20 // Read
#define Target_Pos_1T 0x21 // Read
#define Target_Pos_2R 0x22 // Read
#define Target_Pos_2T 0x23 // Read
#define Target_Pos_3R 0x24 // Read
#define Target_Pos_3T 0x25 // Read
#define Target_Pos_4R 0x26 // Read
#define Target_Pos_4T 0x27 // Read
#define Target_Pos_5R 0x28 // Read
#define Target_Pos_5T 0x29 // Read
#define Target_Pos_6R 0x30 // Read
#define Target_Pos_6T 0x31 // Read
#define Target_Pos_7R 0x32 // Read
#define Target_Pos_7T 0x33 // Read
#define Target_Pos_8R 0x34 // Read
#define Target_Pos_8T 0x35 // Read
#define Target_Pos_9R 0x36 // Read
#define Target_Pos_9T 0x37 // Read
#define Target_Pos_10R 0x38 // Read
#define Target_Pos_10T 0x39 // Read
